package com.example.andrewsauer.weatherapp.weather;
...
/**
 * Created by andrewsauer on 11/21/15.
 */
public class Current {
    ...
    public int getPercipChance() {
        double percipChance = mPercipChance * 100;
        return (int) Math.round(percipChance);
    }
